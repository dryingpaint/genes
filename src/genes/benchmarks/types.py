...
Ported from genbench/types.py with additions for the multi-tier evaluation
framework defined in docs/phenotype-suite/BENCHMARKS.md.
"""
...
class MetricValue(BaseModel):
    """A single metric with bootstrap 95% CI."""
...
class CeilingInfo(BaseModel):
    ...
    ceiling_value: float
    ceiling_source: str  # e.g. "h2_SNP from Yengo 2022"
